...
const required = {
  ...
  NEXT_PUBLIC_DATABASE_ID: process.env.LIVE_STOCKING_DATABASE_ID || process.env.DATABASE_ID,
  NEXT_PUBLIC_TELEMETRY_TABLE_ID: process.env.LIVE_STOCKING_TELEMETRY_TABLE_ID || process.env.TELEMETRY_TABLE_ID,
};
